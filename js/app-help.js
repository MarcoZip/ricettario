...
export const HELP_TOPICS = [
  ...
  { id: "foto-frigo", title: "Sapere cosa cucinare dal frigo (foto)", kw: "frigo frigorifero foto fotografa dispensa cosa cucino ingredienti che ho riconosce", answer: "In Spesa → scheda \"Dispensa\" tocca \"Fotografa il frigo\": l'AI riconosce gli alimenti dalla foto e puoi aggiungerli in dispensa o cercare ricette.", action: { type: "page", target: "spesa-dispensa" } },
  ...
  { id: "menu-settimana", title: "Pianificare il menù della settimana", kw: "menu settimana pianificare piano calendario cene pranzi pasti programmare ai", answer: "Vai in Piano → vista Settimana. Usa \"✨ Menù AI\" per farti proporre le cene dalle tue ricette (con anteprima), oppure \"Riempi le cene\". Da lì generi anche la spesa della settimana.", action: { type: "page", target: "piano" } },
